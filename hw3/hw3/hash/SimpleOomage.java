...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
        ...
        return (that.red == this.red) && (that.blue == this.blue) && (that.green == this.green);
    }
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            //int hash = red*10000 + green *100 + blue; // Does not spread when M = 10;
            int hash = (red*10000 + green *100 + blue) / 5;
            return hash;
        }
    }
